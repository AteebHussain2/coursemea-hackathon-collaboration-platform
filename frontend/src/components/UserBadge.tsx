    ...
    return (
        <div className="relative">
            <button
                ...
                className="flex items-center space-x-3 p-2 rounded-2xl hover:bg-gray-100 transition-all active:scale-95 group border border-transparent hover:border-gray-200"
            >
                ...
                <div className="hidden md:block text-left">
                    ...
                    <p className="text-[10px] text-gray-400 font-black uppercase tracking-widest mt-1">Logged In</p>
                </div>
            ...
            {isOpen && (
                <>
                    ...
                    ></div>
                    <div className="absolute right-0 mt-3 w-64 bg-white rounded-3xl shadow-2xl border border-gray-100 py-3 z-20 animate-in fade-in slide-in-from-top-2 duration-200">
                        ...
                        <div className="px-4 mt-2 mb-2">
                            <div className="bg-linear-to-r from-indigo-50 to-purple-50 rounded-2xl p-4 flex items-center space-x-3 border border-indigo-100/50">
                                <Sparkles className="h-5 w-5 text-indigo-500" />
                                <div>
                                    <p className="text-[10px] font-black text-indigo-600 uppercase tracking-widest leading-none mb-1">Pro Plan</p>
                                    <p className="text-[8px] text-indigo-400 font-bold leading-none">Trial active for 14 days</p>
                                </div>
                            </div>
                        </div>
